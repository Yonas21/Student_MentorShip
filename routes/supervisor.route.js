...
router.post(
  ...
  supervisorController.authenticate_supervisor
);
...
router.get(
  "/:supervisorId",
  supervisorController.get_student_from_a_supervisor
);

router.post("/student/", supervisorController.register_students);
